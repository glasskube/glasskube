...
func (in *PackageManifest) DeepCopyInto(out *PackageManifest) {
	*out = *in
	...
	if in.TransitiveResources != nil {
		...
		*out = make([]TransitiveResource, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TransitiveResource) DeepCopyInto(out *TransitiveResource) {
	*out = *in
	out.GroupVersionKind = in.GroupVersionKind
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TransitiveResource.
func (in *TransitiveResource) DeepCopy() *TransitiveResource {
	if in == nil {
		return nil
	}
	out := new(TransitiveResource)
	in.DeepCopyInto(out)
	return out
}
