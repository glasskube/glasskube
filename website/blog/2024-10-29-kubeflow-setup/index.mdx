...
Then check all the regions except for the one mentionen in the error message and try creating the cluster again.
:::
...
However, it should be noted that we are not specializing in AI or ML at the moment, and are therefore inexperienced in this field.

## Final Thoughts

This concludes our guide on how to setup vanilla Kubeflow on GCP.
If you followed along, you now have a complete and functional Kubeflow installation running on a Kubernetes cluster that automatically scales up or down to accomodate your users CPU and GPU requirements.
