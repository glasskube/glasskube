...
As GitOps became the standard to revision Kubernetes configuration files and use Git as the single source of truth.
...
Also the Renovate automation picks the latest version up and creates a pull request in your GitOps repository.
...
Package scopes give package authors the possibility to control the scope of the installation.
