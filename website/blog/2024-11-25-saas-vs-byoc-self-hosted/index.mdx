...
Anyone who’s ever had to research and source technical B2B tooling is well used to deciphering the [pricing](/pricing/) sections of products websites. These pages are filled with recurring terms like [SaaS](/glossary/saas-definition/), On-Prem, [BYOC](/glossary/byoc-definition/), Self-Service, and [Self-Managed](/glossary/self-managed-software/). Personally, I’ve found myself scratching my head trying to make sense of how they all fit together and how some companies use the same terms sightly differently to others, especially since there’s seemingly no standardized use for many of these terms, some even overlap or are used interchangeably.

<!-- truncate -->

For example, while "On-Premesis" and "Self-Managed" sound similar, they don’t mean the exact same thing. As software vendors deploy to increasingly regulated and complex environments, it’s essential to get some clarity on what these terms actually mean and when they should be used. Let’s untangle this terminology nightmare and establish some clear distinctions around software acquisition and deployment.
...
SaaS offerings are particularly attractive to customers who want a quick, efficient way to start using the software without dedicating time or resources to ongoing maintenance. Software vendors is many cases usually prefer to onboard end-customer onto multi-tenant SaaS versions of their software since it’s more centralised and easier to manage.
...
:::note
Note: The elephant in the BYOC room is that, while some companies may appreciate the convenience of having their infrastructure managed by a software provider—even within an isolated Kubernetes cluster or a dedicated set of VMs—many others will never be comfortable granting infrastructure management permissions or allowing a vendor any level of access to push software into their environments. Making BYOC an unviable option for many.
:::

### **Self-Managed**

The last deployment model is Self-Managed, sometimes referred to as On-Premesis. Personally, I find the mixing of the deployment method with the deployment target environment a bit confusing, as a Self-Managed setups could be running in a private cloud environments and not necessarily in an on-premises data center.

Confusion aside, it's the golden standard for organizations that demand autonomy. Companies choosing Self-Managed deployment methods are often driven by a desire to fully own their environments, whether for compliance, security, or operational efficiency.
...
**On premises environments or data centres**
