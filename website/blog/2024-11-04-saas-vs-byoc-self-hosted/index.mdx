...
Anyone who’s ever had to research and source technical B2B tooling is well used to deciphering the pricing sections of products websites. These pages are filled with recurring terms like SaaS, On-Prem, BYOC, Self-Service, and Self-Managed. Personally, I’ve found myself scratching my head trying to make sense of how they all fit together and how some companies use the same terms sightly differently to others, especially since there’s no standardized use for many of these terms, some even overlap or are used interchangeably.
...
The last deployment model is Self-Managed, sometimes referred to as On-Prem. Personally, I find the mixing of the deployment method with the deployment target environment a bit confusing, as a Self-Managed setups could be running in a private cloud environments and not necessarily in an on-premises data center.
...
![](https://wiki.glasskube.eu/api/attachments.redirect?id=753d43ec-98f2-4570-bb90-cb1e4d153eb7)
...
![](https://wiki.glasskube.eu/api/attachments.redirect?id=c0189014-caf3-4d29-9d39-173aab6fa6bc)
