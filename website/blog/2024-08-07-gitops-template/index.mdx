...
title: The GitOps Kubernetes starter template that gets you set-up in minutes instead of hours
description: "A GitOps starter template to get started with ArgoCD & Glasskube in seconds instead of hours"
authors: [ christophenne, jpage ]
tags: [ glasskube ]
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
    <iframe 
        width="800" 
        height="450" 
        src="https://www.youtube.com/embed/Xbs2Tq-dgbI?si=PfrhS5g0ZVq-YDCi" 
