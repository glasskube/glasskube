...
Yet as [Viktor Farcic](https://www.youtube.com/watch?v=Ny9RxM6H6Hg) put it, “The fact that the StatefulSet is a better choice than a Deployment doesn’t mean it’s a good choice.” For true production-grade database workloads, StatefulSets still lack critical database features like:
...
![](https://wiki.glasskube.eu/api/attachments.redirect?id=a9dbfdeb-bc83-493f-b0ac-494cfd42320c)

## What is needed to run PostgreSQL on Kubernetes

![](https://wiki.glasskube.eu/api/attachments.redirect?id=cdcc9236-6b8b-4755-ad40-7a8036a70e40)
...
![](https://wiki.glasskube.eu/api/attachments.redirect?id=d13f36a4-ce11-4b68-93bf-f32daa1fc108)
