...
> We recently published an [in-depth Helm guide](../what-is-helm-in-kubernetes/), sharing key commands, common errors, best practices and a comprehensive live of FAQs covering many Helm related queries. Check it out.
...
> We recently published an [in-depth Kustomize tutorial](../patching-with-kustomize) that explores the various types of patches, transformers, and generators, along with best practices for using the tool effectively. Be sure to check it out for a more detailed guide.
