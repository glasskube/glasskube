...
Even if you, as a software vendor, might in many cases prefer to onboard a new customer onto your comfortably centralised SaaS offering, the reality is that not all end-customer are in a place to take you up on that offer. Many companies in certain industries like healthcare, banking and government don’t have the luxury of handing over a credit card number and giving Independent software vendors (ISVs) access to their internal infrastructure. Their constraints demand a different approach.
...
![](https://wiki.glasskube.eu/api/attachments.redirect?id=bc4fc818-3115-4211-992c-11e7bbecb2fa)
...
![](https://wiki.glasskube.eu/api/attachments.redirect?id=640d041f-f6b9-4d35-8fea-4e7ec9243893)
...
![](https://wiki.glasskube.eu/api/attachments.redirect?id=fca86a6c-f12b-4791-a283-e0e559a4c5bb)
...
It all starts with building software designed with on-prem readiness in mind. Simply lifting and shifting a SaaS offering to an on-premises customer isn’t a viable option in almost any case. Instead, by starting with a solid foundation of portable software, tested to run in diverse environments, and built with security, compliance, installation infrastructure, and updates as core considerations, you set yourself and your customers up for success.
