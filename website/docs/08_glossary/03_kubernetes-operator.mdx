...
[Kubernetes](/docs/glossary/kubernetes/) is an open-source container orchestration platform for automating the deployment, scaling, and management of containerized applications. A Kubernetes operator utilizes the Kubernetes api to extends the functionality of the Kubernetes platform by allowing users to easily deploy and manage custom applications on top of Kubernetes.
