...
<Tabs groupId="operating-systems">
  ...
  <TabItem value="linux" label="Linux">
    <details>
      ...
      ```
      [sudo] dnf install https://github.com/glasskube/glasskube/releases/download/v0.0.0/glasskube.rpm
      ```
  ...
  <TabItem value="win" label="Windows">
    [//]: # (TODO Exelink + release please version)
    Download the latest from executable from our [Releases](https://github.com/glasskube/glasskube/releases):
  </TabItem>
</Tabs>
