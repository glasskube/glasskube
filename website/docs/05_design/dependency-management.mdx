...
<div style={{maxWidth: '100%', overflow: 'auto'}}>
  <div id="dep-diagram" style={{width: '1600px'}}>
    ...
    G -->|Yes| H("Are there other<br />existing packages<br />dependent on D<br />requiring a version range?")
    H -->|No| I("Is DV inside PDV?")
    I ---->|Yes| Fulfilled
    I ---->|No| K("Is DV < PDV?")
    K --->|Yes| L["P -> D not fulfilled<br /><b>Dependency Conflict</b><br />Resolvable by updating D<br />to max_available(PDV)"]
    K --->|No| M["P -> D not fulfilled<br /><b>Dependency Conflict</b><br />Not resolvable because P<br />does not support D in DV yet"]
    H -->|Yes| N("Is DV inside PDV?")
    N -------->|Yes| Fulfilled
    N ---->|No| P("Is DV < PDV?")
    P --->|Yes| Q["P -> D not fulfilled<br /><b>Dependency Conflict</b><br />Might be resolvable if<br />XDV, YDV, and PDV overlap"]
    P --->|No| R["P -> D not fulfilled<br /><b>Dependency Conflict</b><br />Not resolvable because<br />P does not support D in DV yet"]
