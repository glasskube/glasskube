          ...
          <div className="col col--4">
            <div className="card margin-top--lg">
              ...
              <div className="card__body">
                <p>
                  Ideal for home labs and testing out
                ...
                <ul className={styles.pricingItemList}>
                  ...
                  <li>Use our public package repository or host private packages yourself</li>
                </ul>
              </div>
              <div className="card__footer">
                <Link className="button button--secondary button--block button--lg"
          ...
          <div className="col col--4">
            <div className="card">
              <div className="card__header text--center">
                ...
                Free for clusters with less than 5 nodes<br/>
              ...
              <div className="card__body">
                ...
                <ul className={styles.pricingItemList}>
                  <li>
                    GitOps Integration with pull request enhancement and change preview on a manifest level
                  </li>
                  <li>
                    Backup and restore your installed packages
                  </li>
                  <li>
                    Private hosted packages for secure package distribution
                  </li>
                  <li>
                    Security alerts and update notifications in case of vulnerabilities in your Kubernetes packages for
                    improved software supply chain security
                  </li>
                  <li>
                    Secure cloud access with RBAC for team members
                  </li>
                </ul>
              </div>
              <div className="card__footer">
                <SignupForWaitlistButton additionalClassNames={'button--lg button--block'}/>
              </div>
            </div>
          </div>
          <div className="col">
            <div className="card col--4 margin-top--lg">
              ...
              <div className="card__body">
                <p>
                  Tailor-made solutions for the highest level of cloud security and reliability
                </p>
                <p>
                  All Glasskube Cloud features and:
                </p>
                <ul className={styles.pricingItemList}>
