...
export const PricingFAQs: PricingFAQ[] = [
  ...
  },
  {
    ...
    answer: 'Yes, individual offers from the enterprise plan can be created in different currencies.',
  },
  {
    id: 'gitops',
    question: 'Does Glasskube integrate with existing GitOps solutions?',
    answer: 'Yes, Glasskube integrates into your favorite GitOps solution, by creating pull requests for package upgrades.',
  },
  {
    id: 'paas',
    question: 'Is Glasskube a PaaS solution?',
    answer: 'Glasskube helps you package and deploy Cloud Native Applications into your own Kubernetes cluster. We are not a PaaS solution built on top of Kubernetes, but integrate into your existing workflows.',
  },
  {
    id: 'kubernetes',
