...
const TestimonialList: TestimonialItem[] = [
  {
    ...
    image: 'https://github.com/user-attachments/assets/cb098c0a-d681-4755-ba88-b24e5a5daad4',
    text: 'Glasskube is able to package Trieve for generic Kubernetes clusters and also provide specific overlays for GCP and AWS for one-line installations.' +
  ...
  },
  {
    ...
    role: 'CEO',
    company: 'A1 Digital',
    image: 'https://github.com/user-attachments/assets/8e25ddbe-38f8-4dac-a519-3c901449760c',
    text: 'Glasskube is the perfect solution for powering private infrastructure deployments. It simplifies the process, ' +
  ...
  },
  {
    ...
    role: 'Co-founder',
    company: 'Quickwit',
    image: 'https://github.com/user-attachments/assets/3f94b763-b679-4cb7-9e5b-9c52381e3f10',
    text: 'Glasskube`s intuitive interface has made deploying and managing Quickwit on Kubernetes a breeze. ' +
  ...
  },
  {
    ...
    image: 'https://github.com/user-attachments/assets/fdae75c6-5c31-4c06-98c5-668932f8d1e2',
  ...
  },
  {
    ...
    image: 'https://github.com/user-attachments/assets/2d61a326-e9bc-4982-a800-15c356d99459',
    text: 'Glasskube made it possible to move from being self-hosted only on AWS ECS to being deployed everywhere ' +
  ...
  },
  {
    ...
    company: 'EXOSCALE',
    image: 'https://github.com/user-attachments/assets/432be015-ae42-46b1-bc14-0ae6a79a49ce',
    text: 'Glasskube`s managed open-source tools are a crucial part of our marketplace, enabling secure, fully automated ' +
