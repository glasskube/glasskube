...
<Tabs groupId="operating-systems">
  ...
  <TabItem value="linux" label="Linux">
    ...
    <details>
      ...
      ```
      dnf install https://releases.dl.glasskube.dev/glasskube_v0.4.0_amd64.rpm
      ```
    ...
    <details>
      ...
      {/* x-release-please-start-version */}
      ```
      curl -LO https://releases.dl.glasskube.dev/glasskube_v0.4.0_amd64.apk
  ...
  <TabItem value="win" label="Windows">
    {/* x-release-please-start-version */}
    Download the [windows archive](https://releases.dl.glasskube.dev/glasskube_v0.4.0_windows_x86_64.zip) from our
