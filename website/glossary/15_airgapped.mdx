...
Absolutely! [ISVs](/glossary/isv-meaning/) should be ready to meet the needs of a diverse customer base, including those in highly regulated industries running airgapped environments. It’s a simple reality in today’s market: if you want to serve enterprise customers in these sectors, offering airgapped deployments is often essential. That said, reluctance to support air gapped setups is understandable if you’re not fully prepared. Fortunately, tools like [Glasskube Cloud](/) can simplify the process, handling many of the challenging tasks associated with maintaining software in airgapped environments. These solutions allow vendors to support airgapped customers without direct access to their environments, while still providing a comparable experience to customers in less restrictive settings.
