...
If not, glasskube can easily be installed by following your [distribution's specific instructions](/docs/getting-started/install/).
...
```
For more installation [guides, find them here.](/docs/getting-started/install/)
